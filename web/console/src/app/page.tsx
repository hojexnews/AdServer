      ...
      <nav aria-label="Atalhos rápidos" className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3">
        {[
          ...
          <Link
            key={item.href}
            href={item.href}
            className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm hover:border-brand-500 hover:shadow-md focus-visible:ring-2 focus-visible:ring-brand-500"
          >
