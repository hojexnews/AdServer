...
- **schema E8 — corrigir falso-positivo do `proto-gen-check`** (pin de revisão dos plugins remotos ou plugin local vendorizado). **← próximo item de código de G0.** Dono: `schema-contracts-steward`. Ref: `TX-1`, `.github/workflows/buf.yml`.
